                            ...
                            <div class="card shadow mb-4">
								<div class="notice-area">
									<header class="notice-head">
										<h2><span class="notice-title">${bdo.ntTitle}</span></h2>
									...
									<div class="notice-data">
										<div class="notice-view">
											<pre><p>${bdo.ntContent}</p></pre>
										</div>
									</div>
								</div>
								
								<div class="notice-write-btn-area detail">
									<button class="notice-modify-btn" onclick="location.href='./admin_notice_modify?bdNo=${bdo.bdNo}'">수정</button>
									<button class="notice-delete-btn" onclick="location.href='./admin_notice1'">뒤로가기</button>
								</div>
                            </div>
