...
<body id="page-top">
                            ...
                            <div class="card shadow mb-4 reviewCard">
	                            ...
	                            <input type="hidden" name="bdNo" value="${bdo.bdNo}">
									<div class="notice-write-sub">
										<input type="text" class="input-point" name="ntTitle" value="${bdo.ntTitle}" placeholder="제목을 입력하세요.">
									</div>
									
									<div class="notice-write-cont">
										<textarea class="input-point" name="ntContent" placeholder="내용을 입력하세요.">${bdo.ntContent}</textarea>
									</div>
								</form>	
								<div class="notice-write-btn-area">
									<button class="notice-modify-btn" onclick="check()">수정</button>
									<button class="notice-delete-btn" onclick="location.href='./admin_notice1'">취소</button>
								</div>
                            </div>
	...
	<script>
	    ...
	    if(confirm("정말 수정하시겠습니까?")) {
			fm.action = "admin_notice_modify_action";	
			fm.method = "post";					
