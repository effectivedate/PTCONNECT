...
<body id="page-top">
                            ...
                            <div class="card shadow mb-4 reviewCard">
	                            <form id="form" class="form" name="frm">
									<div class="notice-write-sub">
										<input type="text" class="input-point" name="FAQTitle" placeholder="제목을 입력하세요.">
									</div>
									
									<div class="notice-write-cont">
										<textarea class="input-point" name="FAQContent" placeholder="답변을 입력하세요."></textarea>
									</div>
								</form>		
								<div class="notice-write-btn-area">
									<button class="notice-write-btn" onclick="check()">글쓰기</button>
	...
	function check()
	    ...
	    if(confirm("정말 등록하시겠습니까?")) {
			fm.action = "admin_FAQ_write_action";	
			fm.method = "post";					
