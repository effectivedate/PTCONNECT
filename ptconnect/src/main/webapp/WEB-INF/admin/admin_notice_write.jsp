...
<body id="page-top">
                            ...
                            <div class="card shadow mb-4 reviewCard">
	                            <form id="form" class="form" name="frm">
									<div class="notice-write-sub">
										<input type="text" class="input-point" name="ntTitle" placeholder="제목을 입력하세요.">
									</div>
									
									<div class="notice-write-cont">
										<textarea class="input-point" name="ntContent" placeholder="내용을 입력하세요."></textarea>
									</div>
								</form>	
	...
	<script>
	    ...
	    if(confirm("정말 등록하시겠습니까?")) {
			fm.action = "admin_notice_write_action";	
			fm.method = "post";					
