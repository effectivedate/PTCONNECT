...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <!-- Circle Buttons -->
                            <div class="card shadow mb-4 reviewCard">
	                            <form id="form" class="form" name="frm">
		                            <input type="hidden" name="bdNo" value="${bdo.bdNo}">
									<div class="notice-write-sub">
										<input type="text" class="input-point" name="FAQTitle" value="${bdo.FAQTitle}" placeholder="제목을 입력하세요.">
									</div>
									
									<div class="notice-write-cont">
										<textarea class="input-point" name="FAQContent" placeholder="답변을 입력하세요.">${bdo.FAQContent}</textarea>
									</div>
								</form>	
								<div class="notice-write-btn-area">
									<button class="notice-modify-btn" onclick="check()">수정</button>
									<button class="notice-delete-btn" onclick="location.href='./admin_FAQ1'">취소</button>
								</div>
                            </div>
	...
	function check()
	{
		...
		if(fm.FAQTitle.value=="") {
			alert("제목을 입력하세요.");
			fm.FAQTitle.focus();
			return;
		}
		if(fm.FAQContent.value==""){
    		alert("내용을 입력해주세요.");
    		fm.FAQContent.focus();
    		return;
    	}
    ...
    if(confirm("정말 수정하시겠습니까?")) {
		fm.action = "admin_FAQ_modify_action";	
		fm.method = "post";					
